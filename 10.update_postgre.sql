--PAIIENT
update PAIIENT set P_ADD='P_100',SYS_UPD_DATE='25-Dec-2019' where PID=101;
update PAIIENT set P_ADD='P_101',SYS_UPD_DATE='25-Dec-2019' where PID=102;
update PAIIENT set P_ADD='P_102',SYS_UPD_DATE='25-Dec-2019' where PID=103;
Commit;
